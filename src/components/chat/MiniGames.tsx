    ...
    <div className="fixed inset-0 z-[250] bg-black/60 flex items-center justify-center p-4" onClick={onClose}>
      ...
      {selectedType && (
        <div className="fixed inset-0 z-[260] bg-black/70 flex items-center justify-center p-4" onClick={() => setSelectedType(null)}>
          <div className="bg-[#111] border border-white/10 rounded-2xl w-full max-w-sm max-h-[85vh] flex flex-col overflow-hidden" onClick={e => e.stopPropagation()}>
            ...
            <div className="p-4 overflow-y-auto min-h-0 flex-1">
              ...
              {/* Choix du niveau — uniquement pour le quiz (dans la zone scrollable) */}
              {selectedType === "quiz" && (
