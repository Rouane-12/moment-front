    ...
    <div className="grain min-h-screen pb-24">
      ...
      <div className="relative mx-auto max-w-6xl px-5 py-12">
        ...
        <div className="relative">
          <p className="label-mono">Explorer sans compte</p>
          <h1 className="text-display mt-4 text-5xl uppercase md:text-6xl">
            Où veux-tu sortir ?
          </h1>
          ...
          <input
            ...
            className="mt-8 w-full rounded-full border border-input bg-surface px-6 py-4 text-sm outline-none transition-colors focus:border-primary"
          />
          ...
          <div className="mt-6 flex items-center gap-4">
            <span className="label-mono whitespace-nowrap">≤ {formatFcfa(maxPrice)}</span>
            <input
              type="range"
              min={2000}
              max={10000}
          ...
          {loading ? (
            <div className="mt-12 text-center text-muted-foreground">
              ...
              <p className="mt-4">Chargement des lieux...</p>
            </div>
          ) : (
          ...
          <div className="surface-panel mt-16 flex flex-wrap items-center justify-between gap-6 p-8">
            <div>
              <h2 className="text-display text-3xl uppercase">Tu hésites encore ?</h2>
            ...
            <Link
              to="/moment/create"
              className="rounded-full bg-primary px-7 py-4 text-sm font-bold uppercase tracking-[0.2em] text-primary-foreground"
            >
              🎲 Lancer mon moment
            </Link>
          </div>
